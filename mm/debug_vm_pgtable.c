...
static void __init migration_entry_to_pte_tests(swp_entry_t entry)
{
	...
	decoded = pte_to_swp_entry(pte);
	WARN_ON(swp_type(decoded) != swp_type(entry));
	WARN_ON(swp_offset(decoded) != swp_offset(entry));
}
...
static void __init swap_migration_tests(void)
{
	...
	migration_entry_to_pte_tests(swp);
